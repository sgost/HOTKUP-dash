                                ...
                                <div v-else>
                                  <div v-if="msg.isReceived==true" style="width: 100%;position: relative;display: grid;grid-template-columns: 0px auto;">
                                      <div style="user-select:none">
                                          <!--
                                            <img v-bind:src="'profile/get/' + msg.senderInfoId" style="background-color:white;object-fit: cover;height: 50px;width: 50px;;border-radius: 50%;border: 2px solid #ffffff;filter: drop-shadow(1px 2px 4px #0202024f);">
                                          -->
                                       </div>
  ...
  methods: {
    ...
    */
        ...
        xhr.onload = function () {
          ...
          if (xhr.status >= 200 && xhr.status < 300) {
            ...
            /*
                    ...
                    $("#uploadedImage").attr("src","/profile/get/" + savedImageName);
    ...
    fetchUserImage (userId, selectorId) {
        ...
        fetch(process.env.VUE_APP_API_URL + 'profile/get/' + userId)
        .then((response) => {
