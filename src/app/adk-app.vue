<template>
    ...
    <div class="app-container" data-theme="default" style="position:relative">
      <div id="app-container" class="XXapp-container hide_reveal" style="width: 100% !important;display: flex;flex-direction: column;flex-grow: 9;overflow-y: hidden;" >
                  ...
                  <div class="uk-navbar-item">
                      ...
                      <div>
                          <div v-show="!isUserProfilePanelVisible" v-on:click="showUserProfilePanel()" id="user_profile_trigger" class="clickable-btn user_profile_trigger_inactive uk-button" style="color: white;user-select: none;margin-left:10px;padding: 0px;border-radius: 20px;line-height: inherit;">
                            <img class="uk-border-pill ui-navbar-profile-image"  v-bind:data-img-id="loggedInUser.userId" v-bind:src="'/profile/get/' + loggedInUser.userId"
                      ...
                      <div style="position: relative;padding: 0 10px;">
                            ...
                            <audio style="display:none" id="notification_sound" src="resources/audio/DING.WAV" controls preload="auto" autobuffer></audio>
            ...
            <audio style="display:none" id="new_activity_notification_sound" src="resources/audio/new_activity_notification.mp3" controls preload="auto" autobuffer></audio>
            <audio style="display:none" id="new_chat_notification_sound" src="resources/audio/chat2.mp3" controls preload="auto" autobuffer></audio>
...
<script>
  ...
  methods: {
    ...
    testComlink () {
       ...
       const worker = Comlink.wrap(new Worker("comlink-worker.js"));
    ...
    uploadPic (fieldName, fileList) {
      ...
      xhr.onload = function () {
        ...
        if (xhr.status >= 200 && xhr.status < 300) {
          ...
          document.querySelector('#uploadedImage', '/profile/get/' + savedImageName);
